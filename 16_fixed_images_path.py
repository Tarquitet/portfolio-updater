"""
Universal Manager V18 - Versión 16 (Fixed Copy & Paths)
- Fix: La copia de imágenes ahora es ROBUSTA. Crea carpetas si no existen y normaliza rutas.
- Fix: JSParser ignora strings al buscar constantes (evita basura).
- Fix: Comparación de rutas normalizada (arregla detección de "archivo externo").
"""
import sys
import os
import subprocess
...
class UniversalDBManagerV18:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - Universal Manager V18 (Fixed Copy)")
    ...
    def edit_constants(self):
        ...
        def save(new_c): self.constants = new_c; self.save_file(); self.smart_load()
