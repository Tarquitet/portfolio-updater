"""
Universal Manager V19 - Smart Scan Return & No-Lock
- Fix: Reactivado el escaneo de extensiones (png, jpg, webp, avif) para nombres incompletos en el JS.
- Fix: Mantiene el desbloqueo de archivos (carga en RAM) para permitir sobreescritura.
- Feature: Detecta automáticamente la imagen correcta aunque el JS no tenga la extensión.
"""
import sys
import os
import subprocess
...
class UniversalDBManagerV19:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - Universal Manager V19 (Smart Scan)")
    ...
    def build_ui(self):
        ...
        ttk.Label(h, text="UNIVERSAL DATA V19", font=("Helvetica", 16, "bold"), bootstyle="primary").pack(side="left")
    ...
    def _img_th(self, fn):
        ...
        if str(fn).startswith("http"):
            ...
            # UPDATE V19: Smart Scan Extensiones
            found = None
...
if __name__ == "__main__":
    ...
    app = UniversalDBManagerV19(app_window)
    app_window.mainloop()