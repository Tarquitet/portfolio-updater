"""
Universal Manager V18 - Versión 15
- Fix: get_suggestions ahora es ESTRICTO para constantes (Solo muestra T.X, CAT.X, etc).
- UI Fix: ListEditorDialog ahora tiene botones fijos al fondo (no se esconden con el scroll).
- Feature: Selector de destino para imágenes externas.
...
class UniversalDBManagerV18:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - Universal Manager V18 (Image Master) - v15")
    ...
    def get_suggestions(self, key):
        ...
        if key in map_c and map_c[key] in self.constants:
            ...
            # Ignoramos por completo los valores raw que puedan haber en el archivo
