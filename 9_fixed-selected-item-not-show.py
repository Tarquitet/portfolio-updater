...
# ============================================================
# APP PRINCIPAL (V16 - FIXED)
# ============================================================
class UniversalDBManagerV16:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - Universal Manager V16 (Fixed UI)")
    ...
    def build_ui(self):
        ...
        ttk.Label(h, text="UNIVERSAL DATA V16", font=("Helvetica", 16, "bold"), bootstyle="primary").pack(side="left")
    ...
    def refresh_tabs(self):
        ...
        if not self.datasets: 
            self.lbl_nodata.pack(); return
        else: self.lbl_nodata.pack_forget()
    ...
    def on_select(self, e):
        try:
            ...
            import traceback
            traceback.print_exc()
            messagebox.showerror("Error al seleccionar", f"Detalle:\n{err}")
    ...
    def build_form(self, item):
        ...
        for k in sorted_keys:
            ...
            # FIX: width=15 MOVIDO AL CONSTRUCTOR DEL CHECKBUTTON
            ...
            if is_list:
                ...
                if sug:
                    ent = AutocompleteCombobox(row, all_options=sug); ent.set(str(val))
                else:
...
if __name__ == "__main__":
    ...
    app = UniversalDBManagerV16(app_window)
    app_window.mainloop()