...
# ============================================================
# APP PRINCIPAL (V17 - STABLE)
# ============================================================
class UniversalDBManagerV17:
    def __init__(self, root):
        self.root = root
        self.root.title("Tarquitet - Universal Manager V17 (Stable Release)")
    ...
    def build_ui(self):
        ...
        ttk.Label(h, text="UNIVERSAL DATA V17", font=("Helvetica", 16, "bold"), bootstyle="primary").pack(side="left")
    ...
    def refresh_tabs(self):
        # ERROR FIX: Limpiar widgets de forma segura y recrear aviso si es necesario
...
if __name__ == "__main__":
    ...
    app = UniversalDBManagerV17(app_window)
    app_window.mainloop()